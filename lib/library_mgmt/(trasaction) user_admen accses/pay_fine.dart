...
class Pay_fine extends StatefulWidget {
  @override
  _Pay_fineState createState() => _Pay_fineState();
}

class _Pay_fineState extends State<Pay_fine> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // DropdownButtonFormField(
            //   // ... dropdown options for serial numbers or similar
            // ),
            SizedBox(height: 16.0),
            TextField(
